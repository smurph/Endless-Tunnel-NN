namespace Assets.Scripts.ProcTerrain2D
{
    ...
    public class DynamicWallGenerator : MonoBehaviour
    {
        public static DynamicWallGenerator Instance { get; set; }
        ...
        void Start()
        {
            ...
            if (PerlinSurfaceGenerator.Instance == null) PerlinSurfaceGenerator.Instance = new PerlinSurfaceGenerator(_segmentCount, _perlinResolution, _perlinAmplitude);
        ...
        private void SetupDynamicWalls()
        {
            ...
            PerlinSurfaceGenerator.Instance.Reset(true);
        ...
        void ScrollWalls()
        {
            PerlinSurfaceGenerator.Instance.NextSurfaceHeight();
